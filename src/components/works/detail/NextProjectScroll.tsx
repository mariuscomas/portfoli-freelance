...
export default function NextProjectScroll({ nextProject }: Props) {
  ...
  return (
    <section 
      ref={containerRef} 
      className="relative z-10 w-full bg-surface-base pt-16 md:pt-32 pb-16 md:pb-32 flex flex-col justify-center overflow-hidden border-t border-border-subtle"
    >
