          ...
          >
            {projects.map((project) => (
              ...
              >
                ...
                <h3 className="text-display-s-medium md:text-display-m-medium lg:text-display-l-medium text-text-main group-hover:-translate-y-1 transition-transform duration-300">
                  {project.title}
                </h3>

                <div className="flex items-center gap-12 overflow-hidden">
                  <p className="hidden md:block text-body-s md:text-body-m lg:text-body-l text-text-secondary group-hover:text-text-main transition-colors duration-300">
                    {project.category}
                  </p>
