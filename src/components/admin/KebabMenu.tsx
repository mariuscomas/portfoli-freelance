          ...
          {items.map((item, i) => {
            ...
            return (
              <button
                ...
                className={`flex items-center gap-2.5 px-3 py-2 text-body-xs-light md:text-body-s-light text-left transition-colors disabled:opacity-50 disabled:cursor-not-allowed ${
                  isDanger
