...
export default function ColorField({
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <div className="flex items-center gap-2.5 bg-transparent border border-border-default rounded-md pl-2 pr-3.5 py-1.5 transition-colors hover:border-border-strong focus-within:border-text-main focus-within:ring-2 focus-within:ring-text-main/20">
