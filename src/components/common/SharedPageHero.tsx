...
export default function SharedPageHero({
  ...
  return (
    <div 
      className={`flex flex-col justify-between w-full min-h-[calc(90vh-128px)] lg:min-h-[calc(100vh-40px)] pt-32 md:pt-24 pb-12 mb-0 md:mb-0 px-6 md:px-12 lg:px-16 xl:px-24 ${containerClassName}`}
      style={style}
    >
      ...
      <div className="flex flex-col w-full gap-0 md:gap-6 lg:gap-8">
        ...
        >
          <motion.div
            ...
            className="text-display-h1 flex items-center gap-8 lg:gap-8 w-max px-6 md:px-12 lg:px-24 shrink-0 py-6 transform-gpu will-change-transform"
          >
            {/* Set 1 */}
        ...
        <motion.div
          ...
          className="flex flex-wrap font-medium text-text-main text-body-xl text-text-muted leading-snug md:leading-tight max-w-[90%]"
        >
